...
CFILES	=	ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c ft_strlen.c \
...
BONUS_CFILES  = ft_lstnew.c ft_lstadd_front.c\
				ft_striteri.c ft_lstsize.c ft_lstlast.c \
